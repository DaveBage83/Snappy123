...
extension RetailStoreCurrency {
    ...
    static let mockedEUROData = RetailStoreCurrency(
        currencyCode: "EUR",
        symbol: "&euro;",
        ratio: 0,
        symbolChar: "€",
...
extension RetailStoreDetails {
    ...
    static var mockedDataEmptyDeliveryTiers: RetailStoreDetails {
    ...
    static var mockedDataNoDelivery: RetailStoreDetails {
    ...
    static var mockedDataID1234: RetailStoreDetails {
    ...
    static var mockedDataWithEuroCurrency: RetailStoreDetails {
