...
struct AppV2Constants {
    ...
    struct Business {
        ...
        static let maxAlertCharacterLengthForAutoDismiss = 20 // When alerts have greater character length than this, they will be set automatically to be tap to dismiss alerts and include an xmark button
    }
