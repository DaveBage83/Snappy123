...
class ProductOptionsViewModelTests: XCTestCase {
    ...
    func test_givenItemWithOptions_whenAddItemToBasketTapped_thenAddItemServiceIsTriggeredAndIsCorrect() async {
        ...
        let menuItem = RetailStoreMenuItem(id: 123, name: "", eposCode: nil, outOfStock: false, ageRestriction: 0, description: "", quickAdd: true, acceptCustomerInstructions: false, basketQuantityLimit: 500, price: price, images: nil, menuItemSizes: [size], menuItemOptions: [option], availableDeals: nil)
        
        let container = DIContainer(appState: AppState(), eventLogger: MockedEventLogger(), services: .mocked(basketService: [.addItem(item: BasketItemRequest(menuItemId: 123, quantity: 1, changeQuantity: nil, sizeId: 12, bannerAdvertId: 0, options: [BasketItemRequestOption(id: 123, values: [321], type: .item)], instructions: nil))]))
    ...
    let itemWithOneOptionAndPrice = RetailStoreMenuItem(id: 123, name: "ItemName", eposCode: nil, outOfStock: false, ageRestriction: 0, description: nil, quickAdd: false, acceptCustomerInstructions: false, basketQuantityLimit: 500, price: itemPrice, images: nil, menuItemSizes: nil, menuItemOptions: [toppings], availableDeals: nil)
    
    let itemWithSizesAndPrices = RetailStoreMenuItem(id: 123, name: "ItemName", eposCode: nil, outOfStock: false, ageRestriction: 0, description: nil, quickAdd: false, acceptCustomerInstructions: false, basketQuantityLimit: 500, price: itemPrice, images: nil, menuItemSizes: [sizeS, sizeM, sizeL], menuItemOptions: [], availableDeals: nil)
    
    let itemWithSizesAndOptionsAndPrices = RetailStoreMenuItem(id: 123, name: "ItemName", eposCode: nil, outOfStock: false, ageRestriction: 0, description: nil, quickAdd: false, acceptCustomerInstructions: false, basketQuantityLimit: 500, price: itemPrice, images: nil, menuItemSizes: [sizeS, sizeM, sizeL], menuItemOptions: [toppings], availableDeals: nil)
    ...
    let itemWithTwoIdenticalOptionsAndOneDefault = RetailStoreMenuItem(id: 234, name: "ItemName", eposCode: nil, outOfStock: false, ageRestriction: 0, description: nil, quickAdd: false, acceptCustomerInstructions: false, basketQuantityLimit: 500, price: itemPrice, images: nil, menuItemSizes: nil, menuItemOptions: [
        ...
        RetailStoreMenuItemOption(id: 321, name: "OptionName", type: .item, placeholder: "", instances: 0, displayAsGrid: false, mutuallyExclusive: false, minimumSelected: 0, extraCostThreshold: 0, dependencies: nil, values: [RetailStoreMenuItemOptionValue(id: 456, name: "", extraCost: 0, defaultSelection: 0, sizeExtraCost: nil)])], availableDeals: nil)
