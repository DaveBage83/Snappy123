...
class ProductOptionsViewModelTests: XCTestCase {
    ...
    let itemWithNoOptions = RetailStoreMenuItem(id: 123, name: "ItemName", eposCode: nil, outOfStock: false, ageRestriction: 0, description: nil, quickAdd: false, price: itemPrice, images: nil, sizes: nil, options: nil)
    let itemWithTwoIdenticalOptions = RetailStoreMenuItem(id: 123, name: "ItemName", eposCode: nil, outOfStock: false, ageRestriction: 0, description: nil, quickAdd: false, price: itemPrice, images: nil, sizes: nil, options: [RetailStoreMenuItemOption(id: 123, name: "OptionName", placeholder: nil, maximumSelected: nil, displayAsGrid: nil, mutuallyExclusive: false, minimumSelected: nil, dependentOn: nil, values: [RetailStoreMenuItemOptionValue(id: 123, name: nil, extraCost: nil, default: nil, sizeExtraCost: nil)], type: "Type"), RetailStoreMenuItemOption(id: 123, name: "OptionName", placeholder: nil, maximumSelected: nil, displayAsGrid: nil, mutuallyExclusive: false, minimumSelected: nil, dependentOn: nil, values: [RetailStoreMenuItemOptionValue(id: 123, name: nil, extraCost: nil, default: nil, sizeExtraCost: nil)], type: "Type")])
    
    let itemWith5OptionsOfWhich2Dependencies = RetailStoreMenuItem(id: 123, name: "Fresh Pizzas", eposCode: nil, outOfStock: false, ageRestriction: 0, description: "Choose your own pizza from as little as £5.00 and a drink", quickAdd: false, price: itemPrice, images: nil, sizes: nil, options: [bases, makeAMeal, drinks, sides, toppings])
    
    let itemWithOneOptionAndPrice = RetailStoreMenuItem(id: 123, name: "ItemName", eposCode: nil, outOfStock: false, ageRestriction: 0, description: nil, quickAdd: false, price: itemPrice, images: nil, sizes: nil, options: [toppings])
    
    let itemWithSizesAndPrices = RetailStoreMenuItem(id: 123, name: "ItemName", eposCode: nil, outOfStock: false, ageRestriction: 0, description: nil, quickAdd: false, price: itemPrice, images: nil, sizes: [sizeS, sizeM, sizeL], options: [])
    
    let itemWithSizesAndOptionsAndPrices = RetailStoreMenuItem(id: 123, name: "ItemName", eposCode: nil, outOfStock: false, ageRestriction: 0, description: nil, quickAdd: false, price: itemPrice, images: nil, sizes: [sizeS, sizeM, sizeL], options: [toppings])
    
    static let itemPrice = RetailStoreMenuItemPrice(price: 10, fromPrice: 0, unitMetric: "", unitsInPack: 0, unitVolume: 0, wasPrice: nil)
    
    static let toppings = RetailStoreMenuItemOption(id: 377, name: "Toppings", maximumSelected: 8, mutuallyExclusive: false, minimumSelected: 2, values: [topping1, topping2, topping3, topping4, topping5, topping6, topping7, topping8, topping9], type: "")
    static let bases = RetailStoreMenuItemOption(id: 366, name: "Base", maximumSelected: 1, mutuallyExclusive: true, minimumSelected: 1, values: [base1, base2, base3], type: "")
    static let makeAMeal = RetailStoreMenuItemOption(id: 994, name: "Make a meal out of it", placeholder: "Choose", maximumSelected: 1, displayAsGrid: false, mutuallyExclusive: false, minimumSelected: 1, dependentOn: nil, values: [mealYes, mealNo], type: "")
    static let drinks = RetailStoreMenuItemOption(id: 355, name: "Drinks", maximumSelected: nil, mutuallyExclusive: false, minimumSelected: 0, dependentOn: [222], values: [drink1, drink2, drink3], type: "")
    static let sides = RetailStoreMenuItemOption(id: 344, name: "Side", maximumSelected: 0, mutuallyExclusive: false, minimumSelected: 0, dependentOn: [222], values: [side1, side2, side3], type: "")
    ...
    static let mealYes = RetailStoreMenuItemOptionValue(id: 222, name: "Yes", extraCost: 0, default: nil, sizeExtraCost: nil)
    static let mealNo = RetailStoreMenuItemOptionValue(id: 111, name: "No", extraCost: 0, default: nil, sizeExtraCost: nil)
