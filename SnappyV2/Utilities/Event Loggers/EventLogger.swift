...
enum AppEventScreen: Equatable {
    ...
    case paymentOptions // only at checkout
    case billingDetails // currently only at checkout
    ...
    func toFirebaseEventName(when: AppEventInCheckout) -> String? {
        if when == .outside {
            ...
            case .paymentOptions:               return "view_payment_options"
            case .billingDetails:               return "view_billing_details"
            default:                            return nil
            }
        }
    }
...
enum AppEvent: Equatable {
    ...
    case payByCardSelected
    case payByApplePaySelected
    case payByCashSelected
