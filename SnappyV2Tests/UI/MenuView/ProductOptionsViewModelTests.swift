...
class ProductOptionsViewModelTests: XCTestCase {
    ...
    func test_givenItemWithOptions_whenAddItemToBasketTapped_thenAddItemServiceIsTriggeredAndIsCorrect() async {
        ...
        let menuItem = RetailStoreMenuItem(id: 123, name: "", eposCode: nil, outOfStock: false, ageRestriction: 0, description: "", quickAdd: true, acceptCustomerInstructions: false, basketQuantityLimit: 500, price: price, images: nil, menuItemSizes: [size], menuItemOptions: [option], availableDeals: nil, itemCaptions: nil)
    ...
    let itemWithNoOptions = RetailStoreMenuItem(id: 123, name: "ItemName", eposCode: nil, outOfStock: false, ageRestriction: 0, description: nil, quickAdd: false, acceptCustomerInstructions: false, basketQuantityLimit: 500, price: itemPrice, images: nil, menuItemSizes: nil, menuItemOptions: nil, availableDeals: nil, itemCaptions: nil)
    
    let itemWithTwoIdenticalOptions = RetailStoreMenuItem(id: 123, name: "ItemName", eposCode: nil, outOfStock: false, ageRestriction: 0, description: nil, quickAdd: false, acceptCustomerInstructions: false, basketQuantityLimit: 500, price: itemPrice, images: nil, menuItemSizes: nil, menuItemOptions: [RetailStoreMenuItemOption(id: 123, name: "OptionName", type: .item, placeholder: "", instances: 0, displayAsGrid: false, mutuallyExclusive: false, minimumSelected: 0, extraCostThreshold: 0, dependencies: nil, values: [RetailStoreMenuItemOptionValue(id: 123, name: "", extraCost: 0, defaultSelection: 0, sizeExtraCost: nil)]), RetailStoreMenuItemOption(id: 123, name: "OptionName", type: .item, placeholder: "", instances: 0, displayAsGrid: false, mutuallyExclusive: false, minimumSelected: 0, extraCostThreshold: 0, dependencies: nil, values: [RetailStoreMenuItemOptionValue(id: 123, name: "", extraCost: 0, defaultSelection: 0, sizeExtraCost: nil)])], availableDeals: nil, itemCaptions: nil)
    
    let itemWith5OptionsOfWhich2Dependencies = RetailStoreMenuItem(id: 123, name: "Fresh Pizzas", eposCode: nil, outOfStock: false, ageRestriction: 0, description: "Choose your own pizza from as little as £5.00 and a drink", quickAdd: false, acceptCustomerInstructions: false, basketQuantityLimit: 500, price: itemPrice, images: nil, menuItemSizes: nil, menuItemOptions: [bases, makeAMeal, drinks, sides, toppings], availableDeals: nil, itemCaptions: nil)
    
    let itemWithOneOptionAndPrice = RetailStoreMenuItem(id: 123, name: "ItemName", eposCode: nil, outOfStock: false, ageRestriction: 0, description: nil, quickAdd: false, acceptCustomerInstructions: false, basketQuantityLimit: 500, price: itemPrice, images: nil, menuItemSizes: nil, menuItemOptions: [toppings], availableDeals: nil, itemCaptions: nil)
    
    let itemWithSizesAndPrices = RetailStoreMenuItem(id: 123, name: "ItemName", eposCode: nil, outOfStock: false, ageRestriction: 0, description: nil, quickAdd: false, acceptCustomerInstructions: false, basketQuantityLimit: 500, price: itemPrice, images: nil, menuItemSizes: [sizeS, sizeM, sizeL], menuItemOptions: [], availableDeals: nil, itemCaptions: nil)
    
    let itemWithSizesAndOptionsAndPrices = RetailStoreMenuItem(id: 123, name: "ItemName", eposCode: nil, outOfStock: false, ageRestriction: 0, description: nil, quickAdd: false, acceptCustomerInstructions: false, basketQuantityLimit: 500, price: itemPrice, images: nil, menuItemSizes: [sizeS, sizeM, sizeL], menuItemOptions: [toppings], availableDeals: nil, itemCaptions: nil)
    ...
    let itemWithTwoIdenticalOptionsAndOneDefault = RetailStoreMenuItem(id: 234, name: "ItemName", eposCode: nil, outOfStock: false, ageRestriction: 0, description: nil, quickAdd: false, acceptCustomerInstructions: false, basketQuantityLimit: 500, price: itemPrice, images: nil, menuItemSizes: nil, menuItemOptions: [
        ...
        RetailStoreMenuItemOption(id: 321, name: "OptionName", type: .item, placeholder: "", instances: 0, displayAsGrid: false, mutuallyExclusive: false, minimumSelected: 0, extraCostThreshold: 0, dependencies: nil, values: [RetailStoreMenuItemOptionValue(id: 456, name: "", extraCost: 0, defaultSelection: 0, sizeExtraCost: nil)])], availableDeals: nil, itemCaptions: nil)
