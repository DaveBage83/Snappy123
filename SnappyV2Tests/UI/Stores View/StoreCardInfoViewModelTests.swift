...
class StoreCardInfoViewModelTests: XCTestCase {
    ...
    func test_given4DecimalDistance_thenConvertedTo2DecimalString() {
        let storeDetails = RetailStore(id: 1, storeName: "Slightly Better Store", distance: 3.9638, storeLogo: nil, storeProductTypes: nil, orderMethods: nil)
    ...
    func test_givenDeliveryOrderMethodWithNoCharge_thenFreeDeliveryString() {
        ...
        let storeDetails = RetailStore(id: 1, storeName: "Slightly Better Store", distance: 3.9638, storeLogo: nil, storeProductTypes: nil, orderMethods: ["delivery": deliveryMethod])
        let sut = makeSUT(storeDetails: storeDetails)
