...
class CheckoutOldViewModel: ObservableObject {
...
struct CheckoutOldView: View {
    ...
    @StateObject var viewModel = CheckoutOldViewModel()
...
struct CheckoutOldView_Previews: PreviewProvider {
